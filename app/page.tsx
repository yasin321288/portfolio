    ...
    <div className="relative">
      ...
      >
        <div className="text-center text-white z-10">
          <h1 className="text-6xl md:text-8xl font-bold mb-6 animate-fade-in-up bg-gradient-to-br from-cyan-400 to-green-500 bg-clip-text text-transparent">
            Yasin Sheikh
          </h1>
          <p className="text-xl md:text-2xl mb-8 opacity-80 animate-fade-in-up animation-delay-300">
      ...
      >
        <div className="container mx-auto px-6 text-white">
          <div className="backdrop-blur-md bg-white/10 rounded-3xl p-12 border border-white/20">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="flex justify-center">
                <div className="w-80 h-80 bg-gradient-to-br from-cyan-400/20 to-blue-500/20 rounded-full flex items-center justify-center">
                  <div className="w-60 h-60 bg-gradient-to-br from-cyan-400 to-blue-500 rounded-full opacity-80"></div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="backdrop-blur-md bg-white/10 rounded-3xl p-12 border border-white/20">
            ...
            <div className="mb-16">
              <div className="flex justify-between items-start mb-4">
                ...
                <span className="bg-cyan-400/20 text-cyan-400 px-4 py-1 rounded-full">
                  May 2025 - Present
                </span>
              </div>
        ...
        <div className="container mx-auto px-6 text-white">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {projects.map((project, index) => (
              <div
                key={index}
                className="backdrop-blur-md bg-white/10 rounded-2xl p-8 border border-white/20 hover:scale-105 transition-all duration-500 group cursor-pointer"
              >
                <div
      ...
      >
        <div className="container mx-auto px-6 text-white text-center py-20">
          <div className="backdrop-blur-md bg-white/10 rounded-3xl p-12 border border-white/20 max-w-2xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              <div className="text-center">
                ...
                <a className="text-gray-300">yasinsheikhofficial@gmail.com</a>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-300">+91-9834327583</p>
              </div>
              <div className="text-center">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-300">github.com/yasin321288</p>
              </div>
            </div>
          </div>
        </div>
